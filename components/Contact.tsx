      ...
      <section id="contact" className="py-24">
        <div className="max-w-2xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-400 text-lg leading-8">
            Whether you need a full-time engineer or want to build something
            from scratch — I'm open to conversations. Send me a message and
        ...
        <div className="max-w-xl mx-auto border border-gray-800 rounded-2xl p-8 space-y-5">
          <a
            href="mailto:jonathan13pvc@gmail.com"
            className="flex items-center gap-4 text-gray-400 hover:text-white transition group"
          >
            <div className="w-9 h-9 rounded-lg bg-gray-900 border border-gray-700 flex items-center justify-center group-hover:border-gray-500 transition">
              <Mail size={16} />
            </div>
            <div>
          ...
          >
            ...
            <div>
              ...
              <span>linkedin.com/in/jonathan-uribe-agredo</span>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <span>github.com/JonathanPvc</span>
            </div>
          </a>
          ...
          <div className="flex items-center gap-4 text-gray-500">
            ...
            <div>
              ...
              <span>Cali, Colombia · Remote-friendly</span>
            </div>
          </div>
        </div>
      </section>
